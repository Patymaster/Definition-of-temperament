...
namespace WindowsFormsApp1
{
    ...
    public class Temperaments{
        public static string Sangvinik = "Ви Сангвінік. Сангвінік – це досить енергійна людина, що має життєрадісну натуру. " +
            "Сангвініки є емоційними, вразливими та швидко переходять від одного стану до іншого. Вони зазвичай мають багатий і " +
            "яскравий емоційний досвід та широкі інтереси, що дозволяє їм бути успішними в різних сферах життя. Завжди повні " +
            "енергії та життєвого оптимізму. Вони люблять бути оточені людьми, відчувати їхню підтримку та увагу. Легкість у спілкуванні є " +
            "однією з основних рис сангвініка, що дозволяє їм швидко встановлювати контакт з новими людьми та підтримувати бесіду. Однак Важливо " +
            "для них вчитися контролювати свою енергію та зберігати баланс між роботою та відпочинком.";
        public static string Flegmatik = "Ви Флегматик. Флегматики - це люди, які відрізняються високою стійкістю до стресу " +
            "та мають високу емоційну терпимість. Вони зазвичай є дуже зважливими та спокійними, що дозволяє їм легко " +
            "пристосовуватися до нових ситуацій та зберігати холоднокровний підхід у будь-яких обставинах." +
            "Однак, вони також можуть бути досить замкненими та консервативними в своїх поглядах та переконаннях, " +
            "що може заважати їхній продуктивності та розвитку.";
        public static string Melanholik = "Ви Меланхолік. Меланхоліки - це люди, які відрізняються високим рівнем чутливості та емоційності. " +
            "Вони дуже зосереджені на своїх думках та почуттях, що робить їх досить замкненими інтровертами. Меланхоліки мають тенденцію до " +
            "переживання та роздумів над своїм життям, іноді схильні до меланхолії та депресії. Вони зазвичай дуже аналітичні та розумні, люблять " +
            "глибокі розмови та філософські роздуми. Також, меланхоліки мають сильну потребу в самовираженні та творчості. Проте, меланхоліки часто " +
            "схильні до невпевненості та сумнівів у собі, що може заважати їхній продуктивності та самооцінці. Вони можуть бути досить чутливими до " +
            "критики та занадто переживати за свої помилки або невдачі.";
        public static string Holerik = "Ви Холерик.Холерики –досить емоціональні люди з великим запасом енергії.Вони дуже рішучі та цілеспрямовані, завжди готові" +
            " до дії та здатні до прийняття рішень в короткі терміни. Холерики мають сильний характер та зазвичай не схильні до компромісів," +
            " оскільки вони дуже впевнені в своїй правоті. Холерики мають потребу в руховій активності. Вони не люблять бездіяльність та нудьгування, " +
            "завжди шукають нові враження та виклики. Узагалі, холерики є людьми з сильним характером та великими амбіціями, які завжди прагнуть до " +
            "досягнення своїх цілей. Вони можуть бути успішними лідерами та відмінними підприємцями, але вони також повинні вчитися контролювати свої емоції.";
    }
}
